/*******************************************************************************
 * Testovaci trida Strom_7bTest.
 * 
 * Oproti tride Strom_6aTest obsahuje nasledujici zmeny:
 *  - V pripravku pribyl atribut ap, ve kterem je odkaz na SpravcePlatna
 ...
 */
public class Strom_7bTest extends junit.framework.TestCase
{
    private SpravcePlatna ap;
    private Strom_7b strom1;
    private Strom_7b strom2;
    private Strom_7b strom3;
    private Strom_7b strom4;
...
//== KONSTRUKTORY A TOVARNI METODY =============================================
     ...
     */
    public Strom_7bTest(String nazev)
    {
        super( nazev );
    }
...
//== PRIPRAVA A UKLID PRIPRAVKU ================================================
    ...
    protected void setUp()
    {
        ...
        ap.odstranVse();
        strom1 = new Strom_7b();                        
        strom2 = new Strom_7b( 25, 150);                
        strom3 = new Strom_7b(100, 100, 100,  90);      
        strom4 = new Strom_7b(200,   0, 100, 300, 3, 5);
        strom1.zobraz();
        strom2.zobraz();
        strom3.zobraz();
        strom4.zobraz();
...
//== VLASTNI TESTY =============================================================
    ...
    {
        Strom_7b.obrazek( new Oblast (100, 100, 100, 100), 10 );
