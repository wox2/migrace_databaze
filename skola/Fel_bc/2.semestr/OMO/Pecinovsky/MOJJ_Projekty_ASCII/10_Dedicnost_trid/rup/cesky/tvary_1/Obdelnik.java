 ...
 * se zmenily metody {@link getPozice()}, {@link getRozmer()},
 * {@link getOblast()},  {@link toString()},
 * {@link posunVpravo(int)}, {@link posunDolu(int)}
 * ktere se nyni neobraci primo na atributy, ale ziskavaji pozici
 * prostrednictvim metod {@link getX()} a {@link getY()}.
 *
