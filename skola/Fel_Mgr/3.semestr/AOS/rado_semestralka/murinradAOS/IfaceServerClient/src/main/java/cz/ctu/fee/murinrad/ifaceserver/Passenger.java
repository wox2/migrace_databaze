 ...
 *         &lt;element name="idDocNumber" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
...
@XmlType(name = "passenger", namespace = "http://bookingserver.murinrad.fee.ctu.cz/", propOrder = {
    "id",
    "idDocNumber",
    "name",
    "sex",
