/*******************************************************************************
 * Testovaci trida Strom_4cTest
 * = prebira vse od tridy Strom_4b, a sama pridava:
 *    nic - nova trida pouze pridava komentare
 *
 * @author     Rudolf Pecinovsky
 * @version    2.01, duben 2004
 */
public class Strom_4cTest extends junit.framework.TestCase
{
    private Strom_4c strom1;
    private Strom_4c strom2;
    private Strom_4c strom3;
    private Strom_4c strom4;
...
//== KONSTRUKTORY A TOVARNI METODY =============================================
     ...
     */
    public Strom_4cTest( String nazev )
    {
        super( nazev );
    }
...
//== PRIPRAVA A UKLID PRIPRAVKU ================================================
    ...
    protected void setUp()
    {
        ...
        strom1 = new Strom_4c();                        
        strom2 = new Strom_4c( 25, 150);                
        strom3 = new Strom_4c(100, 100, 100,  90);      
        strom4 = new Strom_4c(200,   0, 100, 300, 3, 5);
    }
