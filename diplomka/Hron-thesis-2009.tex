...
operace namapována na nejméně jednu databázovou operaci. Výjimkou je operace
...
třídy a vytvoří nové ForeignKey s pozměněným jménem , 
  ...
  \begin{description}
    ...
    \item[isAbstract = false] mapuje na prázdnou množinu
  \end{description}
...
\section{Změny Databázového Structury}
...
řetězec '\_ord'.
Vzhledem k unikátnosti dvojice (class, property) bylo využito mapování prefix spojený s přelozeným názvem třídy a
přeloženým názvem property.
$$owningClstranslation = translate(owningClassName)$$
$$propertyTranslation = translate(primitivePropertyName)$$
