...
public class MWin extends JFrame {
    ...
    private JSpinner rozmerSloupce;
    ...
    private void insertMatrix(Matrix insertedMatrix) {
        ...
        rozmerSloupce = new JSpinner();
        JLabel rozmerSlLabel = new JLabel("Sloupcu");
        rozmerSlLabel.setLabelFor(rozmerSloupce);
        add(rozmerSlLabel);
        rozmerSloupce.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                ...
                try {
                    ...
                    rozmerSloupce.setValue(matrix.getNumberColumns());
                }
            }
        });
