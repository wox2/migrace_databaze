...
//== VLASTNI TESTY =============================================================
    ...
    {
        TKabina[] k3 = vytvorTrojici( Kabina_10a.class );
        zrychliLinky();
        ukonciSkupinu( k3 );
    }
    ...
    {
        TKabina[] k3 = vytvorTrojici( Kabina_10b.class );
        zrychliLinky();
        ukonciSkupinu( k3 );
    }
    ...
    {
        TKabina[] k3 = vytvorTrojici( Kabina_10c.class );
        zrychliLinky();
        ukonciSkupinu( k3 );
    }
    ...
    {
        TKabina[] k3 = vytvorTrojici( ZpetnaKabina_10a.class );
        zrychliLinky();
        ukonciSkupinu( k3 );
    }
    ...
    {
        TKabina[] k3 = vytvorTrojici( ZpetnaKabina_10b.class );
        zrychliLinky();
        ukonciSkupinu( k3 );
    }
    ...
    {
        TKabina[] k3 = vytvorTrojici( ZpetnaKabina_10c.class );
        zrychliLinky();
        ukonciSkupinu( k3 );
    }
    ...
    {
        TKabina[] k3 = vytvorTrojici( ZpetnaKabina_10d.class );
        zrychliLinky();
        ukonciSkupinu( k3 );
    }
    ...
    {
        TKabina[] tam3 = vytvorTrojici( Kabina_10c.class );
        TKabina[] zpet3 = vytvorTrojici( ZpetnaKabina_10d.class );
        zrychliLinky();
        ukonciSkupinu( tam3 );
        ukonciSkupinu( zpet3 );
    }
