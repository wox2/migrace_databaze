...
import Mode.AMinusB;
import Mode.AMultipleB;
import Mode.AMultipleConstant;
import Mode.APlusB;
import Mode.ATranspose;
import Mode.BMinusA;
import Mode.BMultipleA;
import Mode.BMultipleConstant;
import Mode.BTranspose;
import Mode.Mode;
...
public class ActionButts extends Container {
    ...
    public ActionButts(Win w) {
        ...
        JLabel constLabel = new JLabel("Multiplikator c");
        constLabel.setLabelFor(tf);
        add(constLabel);
        ...
        equal.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                chosen.perform(window.getMatrixA(), window.getMatrixB(), constant, window.getResults());
            }
        });
    }
}
