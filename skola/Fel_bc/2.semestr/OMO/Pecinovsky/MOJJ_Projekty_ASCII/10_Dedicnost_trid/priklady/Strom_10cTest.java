 ...
 */
public class Strom_10cTest extends junit.framework.TestCase
{
    private SpravcePlatna ap;
    private Strom_10c strom1;
    private Strom_10c strom2;
    private Strom_10c strom3;
    private Strom_10c strom4;
...
//== KONSTRUKTORY A TOVARNI METODY =============================================
     ...
     */
    public Strom_10cTest(String nazev)
    {
        super( nazev );
    }
...
//== PRIPRAVA A UKLID PRIPRAVKU ================================================
    ...
    protected void setUp()
    {
        ...
        ap.setMrizka(true);
        ap.odstranVse();
        strom1 = new Strom_10c();                        
        strom2 = new Strom_10c( 25, 150);                
        strom3 = new Strom_10c(100, 100, 100,  90);      
        strom4 = new Strom_10c(200,   0, 100, 300, 5, 5);
        strom1.zobraz();
        strom2.zobraz();
        strom3.zobraz();
        strom4.zobraz();
...
//== VLASTNI TESTY =============================================================
    ...
    {
        Strom_10c.obrazek( new Oblast (100, 100, 100, 100), 10 );
