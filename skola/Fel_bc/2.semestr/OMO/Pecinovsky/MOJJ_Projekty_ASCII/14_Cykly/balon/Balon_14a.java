...
/*******************************************************************************
 * Trida {@code Balon_14a} simuluje meky padajici balon,
 * ktery pada zrychlene dolu a po dopadu zustane lezet tam, kam dopadl.
 *
 * @author    Rudolf Pecinovsky
 * @version   0.00.000,  0.0.2003
 */
public final class Balon_14a
{
...
//== KONSTRUKTORY A TOVARNI METODY =============================================
     ...
     */
    public Balon_14a(int x, int y, int prumer, Barva barva)
    {
...
//== TESTY A METODA MAIN =======================================================
    ...
    public static void test()
    {
        ...
        Balon_14a b1 = new Balon_14a();
        Balon_14a b2 = new Balon_14a( 100, 100, 50, Barva.MODRA );
        b1.presunNa( 50, 50 );
    }
