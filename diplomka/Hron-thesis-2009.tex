...
zvětšující se s počtem rozpoznávaných operací. Algoritmus popsaný v pseudokódu
viz algoritmus \ref{algo:state}
%\\
...
elementů modelu. Tato konfigurace se používá k zjištění vzdálenosti mezi
jednotlivými modely.
\begin{itemize}
