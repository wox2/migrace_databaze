...
aplikační a databázový metamodel.
...
skriptů nad databází, ale po konzultaci s CP byl vzhledem k znovupoužitelnosti
SQL souborů z frameworku vypuštěn. 
...
\chapter{Řešení problému rozpoznávání operací}
...
nutné vybrat si správný algoritmus v závislosti na řešeném problému.
 ...
 \begin{itemize}
   \item Párování podle statického identifikátoru páruje elementy podle
	...
	\item Algoritmy v kategorii Custom language specific matching jsou vytvořené
