 ...
 */
public class Vytah_9 implements IPosuvny
{
...
//== KONSTRUKTORY A TOVARNI METODY =============================================
     ...
     */
    public Vytah_9(int sloupec, int rychlost, Barva barva)
    {
...
//== SOUKROME A POMOCNE METODY TRIDY ===========================================
    ...
    private void vystup( int posun )
    {
	    ...
	    SP.pridejPod( this, this.pasazer );
