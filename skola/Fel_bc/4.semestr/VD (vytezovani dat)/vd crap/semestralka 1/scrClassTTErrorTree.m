...
inputs = double( karty(:,varInd) );
outputs = double( karty.class );
outputs(outputs ~= 1) = 2; % Convert to american/nonamerican task

% Prepare training and testing data, use 60 percent for training
[itrn,itst] = splitData( size(karty,1), 0.6 );

 splitminArray = [200 180 150 120 100 80 60 40 20 10 5 1];
%splitminArray = [2 5 10 20 40 60 80 1000 1200 1500 1800 2000];
