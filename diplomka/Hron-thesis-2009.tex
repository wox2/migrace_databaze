...
Při transformaci asociačních property s atributem isOwning = true a upperBound
!= 1 na asociační tabulku je nutné zajistit unikátnost názvu této tabulky.
Neexistuje předpoklad, že by byl název property unikátní ve všech třídách. Ale
dvojice (table, property) musí být unikátní. Proto je název asociační tabulky
získán jako spojení názvu vlastnické tabulky s názvem asociační property pomocí
znaku "\_".
...
\section{Migdb Diff a textová reprezentace modelu}

V rámci projektu Migdb nepracujeme se soubory, ale s modely. Každý model je
možné textově reprezentovat. Pro jednoduchost si můžeme reprezentovat textově s
...
\end{itemize}
 ...
 textovou reprezentací. Model M_1 = odpovídající této reprezentaci je zobrazen
 na obrázku \ref{fig:basic_text_repre}. Na obrázku je slovem undefined znázorněno,
 že Jednoduchá textová reprezentace neposkytuje žádné informace o typu. Pro
 reprezenraci odpovídající Modelu Typ properties tedy 
 
 \begin{figure}[H]
\begin{center}
\includegraphics[width=5cm]{figures/basic_text_notation_1}
\caption{Model ekvivalentní základní textové reprezentaci}
