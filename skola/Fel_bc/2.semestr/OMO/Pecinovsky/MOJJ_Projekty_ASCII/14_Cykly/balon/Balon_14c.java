...
/*******************************************************************************
 * Trida {@code Balon_14c} simuluje pruzny padajici balon,
...
//== KONSTRUKTORY A TOVARNI METODY =============================================
     ...
     */
    public Balon_14c(int x, int y, int prumer, Barva barva)
    {
...
//== TESTY A METODA MAIN =======================================================
    ...
    public static void test()
    {
        ...
        Balon_14c b1 = new Balon_14c();
        Balon_14c b2 = new Balon_14c( 100, 100, 50, Barva.MODRA );
        b1.presunNa( 50, 50 );
    }
