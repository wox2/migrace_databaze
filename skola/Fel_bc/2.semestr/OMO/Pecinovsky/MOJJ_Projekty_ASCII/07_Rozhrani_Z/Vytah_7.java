/*******************************************************************************
 * Trida Vytah_7 simuluje vytah vozici pasazery
 *
 * @author    Rudolf Pecinovsky
 * @version   0.00.000,  0.0.2003
 */
public class Vytah_7 implements IKresleny, IPosuvny
{
...
//== KONSTANTNI ATRIBUTY INSTANCI ==============================================
    ...
    /** Vytah_7 pouzije pro vsechny posuny jednoho soukromeho presouvace. */
...
//== PREKRYTE KONKRETNI METODY RODICOVSKE TRIDY ================================
     ...
     * vytahu, sloupec, v nemz jezdi a cil, v nemz se prave nachazi.
     *
    ...
    {
        return "Vytah_6_" + poradi + ": sloupec=" +
               sloupec + ", patro=" + patro;
    }
...
//== NOVE ZAVEDENE METODY INSTANCI =============================================
    ...
    public void nastup( IPosuvny pasazer )
    {
        ...
        SP.pridejPod( (IKresleny)this, (IKresleny)pasazer );
     ...
     *
     * @param cil   Poradove cislo ciloveho patra (prizemi ma 0).
     */
    public void doPatra( int cil  )
    {
        presouvac.presunO( this, 0, (this.patro - cil)*SP.getKrok() );
        this.patro = cil;
    }
...
//== SOUKROME A POMOCNE METODY TRIDY ===========================================
    ...
    private void vystup( int posun )
    {
	    ...
	    SP.pridejPod( (IKresleny)this, (IKresleny) this.pasazer );
