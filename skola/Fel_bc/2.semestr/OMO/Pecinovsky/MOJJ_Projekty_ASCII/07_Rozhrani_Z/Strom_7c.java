/*******************************************************************************
 * Trida Strom_7c obsahuje podobu tridy po zavedeni metod 
 * pro nastaveni rozmeru instance .
 *
 *  Oproti tride {&code Strom_7b} je zmeneno:
 ...
 */
public class Strom_7c implements IKresleny, IPosuvny
{
...
//== OSTATNI METODY TRIDY ======================================================
    ...
    public static void zaramuj( int sirka, int vyska )
    {
        SP.nekresli(); {        
            ...
            new Strom_7c( 0, 0, sirka, vyska ).zobraz();
        } SP.vratKresli();
    }
    ...
    public static void alej()
    {
        SP.nekresli(); {        
            ...
            new Strom_7c( 100,   0 ).zobraz();
            new Strom_7c( 300,   0 ).zobraz();
            new Strom_7c(  50, 100 ).zobraz();
            new Strom_7c( 250, 100 ).zobraz();
            new Strom_7c(   0, 200 ).zobraz();
            new Strom_7c( 200, 200 ).zobraz();
        } SP.vratKresli();
    }
...
//== KONSTRUKTORY A TOVARNI METODY =============================================
     ...
     */
    public Strom_7c( int x, int y, int sirka, int vyska )
    {
     ...
     */
    public Strom_7c(Pozice pozice, Rozmer rozmer)
    {
