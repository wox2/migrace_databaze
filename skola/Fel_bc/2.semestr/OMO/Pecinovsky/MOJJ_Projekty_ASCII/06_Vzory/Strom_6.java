/*******************************************************************************
 * Trida Strom_6 rozsiruje definici o konstrukce probrane v podkapitole
 * o prepravkach.
 *
 *  Od Strom_6 je tu pridano:
...
//== OSTATNI NESOUKROME METODY TRIDY ===========================================
    ...
    public static void alej()
    {
        ...
        new Strom_6( 100,   0 );      new Strom_6( 300,   0 );
        new Strom_6(  50, 100 );      new Strom_6( 250, 100 );
        new Strom_6(   0, 200 );      new Strom_6( 200, 200 );
    }
     ...
     * 
     * @param oblast    Oblast, v niz se ma vytvorit zaramovany obrazek
     * @param sirkaRamu Sirka ramu obrazku
     */
...
//== KONSTRUKTORY A TOVARNI METODY =============================================
     ...
     */
    public Strom_6( int x, int y, int sirka, int vyska )
    {
     ...
     */
    public Strom_6(Pozice pozice, Rozmer rozmer)
    {
