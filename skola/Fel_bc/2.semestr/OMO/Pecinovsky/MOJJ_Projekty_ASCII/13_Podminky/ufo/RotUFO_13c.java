...
/*******************************************************************************
 * Trida RotUFO_13c obsahuje vzorove reseni pro tridu UFO, ktera
 ...
 */
public class RotUFO_13c extends RotUFO_13b
{
...
//== KONSTRUKTORY A TOVARNI METODY =============================================
     ...
     */
    public RotUFO_13c(Talir talir, int poradi)
    {
        super( talir, poradi );
    }
...
//== TESTY A METODA MAIN =======================================================
     ...
     * Testovaci metoda.
     */
    public static void start_R13c()
    {
        System.out.println();
        Dispecer.getDispecer().pouzijTridu( RotUFO_13c.class    );
    }
