...
/*******************************************************************************
 * Trida Strom_10b obsahuje podobu tridy po definici rodicovske tridy Hybaci. 
 *
 *  Oproti tride {&code Strom_10a} je zmeneno:
 *  - Zmenena rodicovska trida na Hybaci
 *  - Odebrany metody, ktere trida muze od sveho rodice zdedit
 *  - Upraven pracujici konstruktoru aby vovla noveho rodice
 *  - upravena metoda setRozmer(int,int)
 *
 * @author     Rudolf Pecinovsky
 * @version    2.01, duben 2004
 */
public class Strom_10b extends Hybaci implements IHybaci
{
...
//== OSTATNI NESOUKROME METODY TRIDY ===========================================
    ...
    public static void zaramuj( int sirka, int vyska )
    {
        SP.nekresli(); {        
            ...
            new Strom_10b( 0, 0, sirka, vyska ).zobraz();
        } SP.vratKresli();
    }
    ...
    public static void alej()
    {
        SP.nekresli(); {        
            ...
            new Strom_10b( 100,   0 ).zobraz();
            new Strom_10b( 300,   0 ).zobraz();
            new Strom_10b(  50, 100 ).zobraz();
            new Strom_10b( 250, 100 ).zobraz();
            new Strom_10b(   0, 200 ).zobraz();
            new Strom_10b( 200, 200 ).zobraz();
        } SP.vratKresli();
    }
...
//== KONSTRUKTORY A TOVARNI METODY =============================================
     ...
     */
    public Strom_10b(int x, int y, int sirka, int vyska)
    {
     ...
     */
    public Strom_10b(Pozice pozice, Rozmer rozmer)
    {
     ...
     */
    public Strom_10b(Oblast oblast)
    {
     ...
     */
    public Strom_10b(int x, int y, int sirka, int vyska, int podilSirkyKmene, int podilVyskyKmene)
    {
