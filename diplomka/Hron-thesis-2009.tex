...
struktury aplikace na DB schema + ODBCHM transformace obsažené v workflow
...
otestování než manuální spuštění a vizuální porovnáných selectů s vstupním
souborem data.sql.
...
psaní transformace ODBCHM snazší. Tato transformace je esenciální pro chod
