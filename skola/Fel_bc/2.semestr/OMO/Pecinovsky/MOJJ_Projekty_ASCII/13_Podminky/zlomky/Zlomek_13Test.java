...
/*******************************************************************************
 * Testovaci trida Zlomek_13Test slouzi ke komplexnimu otestovani vzoroveho
 * reseni definice tridy zlomku spolu s operacemi zlomkove aritmetiky.
 *
 * @author    Rudolf Pecinovsky
 * @version   0.00.000,  0.0.2003
 */
public class Zlomek_13Test extends junit.framework.TestCase
{
    Zlomek_13 z0, z1, z2, z12, z34, z56;
    Zlomek_13 v1, v2, v3;
...
//== PRIPRAVA A UKLID PRIPRAVKU ================================================
    ...
    protected void setUp()
    {
        ...
        z1 = new Zlomek_13( 1 );
        z2 = new Zlomek_13( 2 );
        z12 = new Zlomek_13( 1, 2 );
        z34 = new Zlomek_13( 3, 4 );
        z56 = new Zlomek_13( 5, 6 );
    }
...
//== SOUKROME A POMOCNE METODY TRIDY ===========================================
     ...
     */
    public static void tiskni( Zlomek_13 v, Zlomek_13 z1, char op, Zlomek_13 z2 )
    {
     ...
     */
    public static void tiskni( String cislo, Zlomek_13 z )
    {
...
//== VLASTNI TESTY =============================================================
    ...
    public void testPrevody()
    {
        int i;
        double d;
        Zlomek_13 z125 = new Zlomek_13( 12, 5 );
