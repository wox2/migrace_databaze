 ...
 */
public class Strom_7cTest extends junit.framework.TestCase
{
    private SpravcePlatna ap;
    private Strom_7c strom1;
    private Strom_7c strom2;
    private Strom_7c strom3;
    private Strom_7c strom4;
...
//== KONSTRUKTORY A TOVARNI METODY =============================================
     ...
     */
    public Strom_7cTest(String nazev)
    {
        super( nazev );
    }
...
//== PRIPRAVA A UKLID PRIPRAVKU ================================================
    ...
    protected void setUp()
    {
        ...
        ap.odstranVse();
        strom1 = new Strom_7c();                        
        strom2 = new Strom_7c( 25, 150);                
        strom3 = new Strom_7c(100, 100, 100,  90);      
        strom4 = new Strom_7c(200,   0, 100, 300, 3, 5);
        strom1.zobraz();
        strom2.zobraz();
        strom3.zobraz();
        strom4.zobraz();
...
//== VLASTNI TESTY =============================================================
    ...
    {
        Strom_7c.obrazek( new Oblast (100, 100, 100, 100), 10 );
