...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-Release.mk dist/Release/Cygwin-Windows/fresh_start.exe

dist/Release/Cygwin-Windows/fresh_start.exe: ${OBJECTFILES}
...
${OBJECTDIR}/AbstractPriorityQueue.o: AbstractPriorityQueue.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/AbstractPriorityQueue.o AbstractPriorityQueue.cpp

${OBJECTDIR}/ComunicationNetwork.o: ComunicationNetwork.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/ComunicationNetwork.o ComunicationNetwork.cpp
...
${OBJECTDIR}/NetworkCreator.o: NetworkCreator.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/NetworkCreator.o NetworkCreator.cpp

${OBJECTDIR}/Condensator.o: Condensator.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Condensator.o Condensator.cpp
...
${OBJECTDIR}/StrongComponent.o: StrongComponent.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/StrongComponent.o StrongComponent.cpp
...
${OBJECTDIR}/HighPredecessorsPriorityQueue.o: HighPredecessorsPriorityQueue.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/HighPredecessorsPriorityQueue.o HighPredecessorsPriorityQueue.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/Release
	${RM} dist/Release/Cygwin-Windows/fresh_start.exe
