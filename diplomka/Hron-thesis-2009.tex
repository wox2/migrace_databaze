...
%\State Vzdálenost modelů $D\gets$ dist(S, T)
   ...
   modelu}
   \State $TClses \gets T.classes$ \Comment{Nenamatchované třídy z cílového
   modelu}
   ...
   \ForAll{$C_S \in S: \exists C_T \in  T \: C_T.name = C_S.name$} \Comment{b}
