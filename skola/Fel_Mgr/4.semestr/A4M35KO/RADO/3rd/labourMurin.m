...
b = [6 6 6 6 6 8 9 12 18 22 25 21 21 20 18 21 21 24 24 18 18 18 12 8]';                            %vektor b
c = ones(1,24);            %vektor c

ctype = zeros(24,1);   %typ podminky: 'E'="=", 'L'="<=", 'G'=">="
for i=1:24
    ctype(i,1)='G';
end
ctype = char(ctype);
...
lb = 0*ones(24,1);            %dolni mez promenych
ub = 25*ones(24,1);            %horni mez promenych

vartype = zeros(24,1);   %Typ promenne 'C'=spojita, 'I'=celociselna
for i=1:24 
    vartype(i,1)='I';
end
