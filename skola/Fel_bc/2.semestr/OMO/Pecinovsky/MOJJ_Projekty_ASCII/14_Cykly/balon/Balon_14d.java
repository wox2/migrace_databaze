...
/*******************************************************************************
 * Trida {@code Balon_14d} simuluje pruzny padajici balon,
 ...
 * Testovaci metoda vsak nezvlada 
 * pockani s presunem balonku na ukonceni jeho padu.
 *
 * @author    Rudolf Pecinovsky
 * @version   0.00.000,  0.0.2003
 */
public final class Balon_14d implements Runnable
{
...
//== KONSTRUKTORY A TOVARNI METODY =============================================
     ...
     */
    public Balon_14d(int x, int y, int prumer, Barva barva)
    {
...
//== TESTY A METODA MAIN =======================================================
    ...
    public static void test()
    {
        ...
        Balon_14d b1 = new Balon_14d();
        rup.cesky.utility.IO.cekej(1000);
        Balon_14d b2 = new Balon_14d( 100, 100, 50, Barva.MODRA );
        b1.presunNa( 50, 250 );
    }
