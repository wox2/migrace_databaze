...
\end{figure}
 ...
 párování podle statického identifikátoru, 2. signature based matching, 3.
 similarity based matching)nejsou taktéž vhodné k použití z důdodu, že popsané
 expanzivní a reduktivní operace  mně inspirovaly k vytvoření Problém hledání
 sekvence operací by byl založen na
