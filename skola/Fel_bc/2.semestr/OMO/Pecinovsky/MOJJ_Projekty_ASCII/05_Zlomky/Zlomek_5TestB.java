/*******************************************************************************
 * Testovaci trida Zlomek_5TestB slouzi ke komplexnimu otestovani vzoroveho
 * reseni definice tridy zlomku spolu s operacemi zlomkove aritmetiky.
 * Oproti tride Zlomek_5Test jiz neporovnava texty, ale primo zlomky.
 *
 * @author    Rudolf Pecinovsky
 * @version   0.00.000,  0.0.2003
 */
public class Zlomek_5TestB extends junit.framework.TestCase
{
...
//== VLASTNI TESTY =============================================================
    ...
    public void testPlus()
    {
        v1 = z1.plus( z2 );    
        tiskni( v1, z1, '+', z2 );
        assertEquals( new Zlomek_5(3), v1 );
        
        v2 = z12.plus( z34 );  
        tiskni( v2, z12, '+', z34 );
        assertEquals( new Zlomek_5(5,4), v2 );
        ...
        v3 = v1.plus(v2);      
        tiskni( v3, v1, '+', v2 );
        assertEquals( new Zlomek_5(17,4), v3 );
        
        v3 = v2.plus(v2);      
        tiskni( v3, v2, '+', v2 );
        assertEquals( new Zlomek_5(5,2), v3 );
        
        v3 = v2.plus(2);      
        tiskni( v3, v2, '+', new Zlomek_5(2) );
        assertEquals( new Zlomek_5(13,4), v3 );
    }
    ...
    public void testMinus()
    {
        v1 = z1.minus( z2 );    
        tiskni( v1, z1, '-', z2 );
        assertEquals( new Zlomek_5(-1), v1 );
        
        v2 = z12.minus( z34 );
        tiskni( v2, z12, '-', z34 );
        assertEquals( new Zlomek_5(-1,4), v2 );
        ...
        v3 = v1.minus(v2);
        tiskni( v3, v1, '-', v2 );
        assertEquals( new Zlomek_5(-5,4), v3 );
        
        v3 = v2.minus(v2);
        tiskni( v3, v2, '-', v2 );
        assertEquals( new Zlomek_5(0), v3 );
        
        v3 = v2.minus(2);
        tiskni( v3, v2, '-', new Zlomek_5(2) );
        assertEquals( new Zlomek_5(-7,4), v3 );
    ...
    public void testKrat()
    {
        v1 = z1.krat( z2 );
        tiskni( v1, z1, '*', z2 );
        assertEquals( new Zlomek_5(2), v1 );
        
        v2 = z12.krat( z34 );
        tiskni( v2, z12, '*', z34 );
        assertEquals( new Zlomek_5(3,8), v2 );
        ...
        v3 = v1.krat(v2);
        tiskni( v3, v1, '*', v2 );
        assertEquals( new Zlomek_5(3,4), v3 );
        
        v3 = v2.krat(v2);
        tiskni( v3, v2, '*', v2 );
        assertEquals( new Zlomek_5(9,64), v3 );
    ...
    public void testDeleno()
    {
        v1 = z1.deleno( z2 );    
        tiskni( v1, z1, ':', z2 );
        assertEquals( new Zlomek_5(1,2), v1 );
        
        v2 = z12.deleno( z34 );
        tiskni( v2, z12, ':', z34 );
        assertEquals( new Zlomek_5(2,3), v2 );
        
        v2 = z34.deleno( z12 );
        tiskni( v2, z34, ':', z12 );
        assertEquals( new Zlomek_5(3,2), v2 );
        
        v3 = v1.deleno(v2);
        tiskni( v3, v1, ':', v2 );
        assertEquals( new Zlomek_5(1,3), v3 );
        
        v3 = v2.deleno(v2);
        tiskni( v3, v2, ':', v2 );
        assertEquals( new Zlomek_5(1), v3 );
        ...
        v3 = v2.delCislo(2);
        tiskni( v3, new Zlomek_5(2), ':', v2 );
        assertEquals( new Zlomek_5(4,3), v3 );
    }
