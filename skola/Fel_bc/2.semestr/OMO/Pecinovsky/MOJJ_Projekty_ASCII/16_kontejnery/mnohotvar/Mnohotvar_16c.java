...
/*******************************************************************************
 * Trida {@code Mnohotvar_16c} slouzi k demonstraci prace se seznamy.
 ...
 */
public class Mnohotvar_16c extends AHybaci
{
...
//== KONSTRUKTORY A TOVARNI METODY =============================================
     ...
     */
    public Mnohotvar_16c(String nazev)
    {
        super( 0, 0, 0, 0 );
        if( ! nazev.equals("") ) {
            this.nazev = nazev;
    ...
    public void setRozmer( int sirka, int vyska )
    {
        ...
        SP.nekresli(); {
            for( IHybaci ih : seznam )
            {
                ...
                ih.setRozmer( (int)Math.round(ss * roz.sirka),
                              (int)Math.round(vv * roz.vyska) );
                //Pri zmene velikosti se podobjekt take posune
                Pozice poz = ih.getPozice();
                int dhx = (int)Math.round((poz.x - getX()) * ss);
                int dhy = (int)Math.round((poz.y - getY()) * vv);
                ih.setPozice( (getX() + dhx), (getY() + dhy));
            }
