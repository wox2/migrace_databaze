...
Create table hral_deck_na_turnaji (
      hrac_hdnt_Osoba_Id Integer Not Null,
...
Alter table hral_deck_na_turnaji add (
      Constraint FK_hral_deck_na_turnaji_1 Foreign Key (hrac_hdnt_Osoba_Id) References hrac(Osoba_Id),
      Constraint FK_hral_deck_na_turnaji_2 Foreign Key (Deck_hdnt_id) References Deck(id),
      Constraint FK_hral_deck_na_turnaji_3 Foreign Key (turnaj_hdn_id) References turnaj(id)
);
